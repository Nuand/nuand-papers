...
\def \emailrghilduta    {\href{mailto:robert.ghilduta@nuand.com?cc=bladeRF@nuand.com}{\textless{robert.ghilduta@nuand.com}\textgreater}}
...
\def \contributors{
  \begin{table}[h]
    ...
    \begin{tabular}{c}
      Dr. Juan R. Pimentel \\
      \textless{jpimente@kettering.edu}\textgreater \\
...
\def \revisions {
  \begin{table}[h]
    ...
    \begin{tabular}{|c|c|l|}
      ...
      4  & 2016-06-21 & Typo fix in Section \ref{sec:tx} \\ \hline
    \end{tabular}
  \end{table}
}
...
\subsection{Transmission} \label{sec:tx}
