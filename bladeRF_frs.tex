...
The device comprises of a Cypress FX3 USB3 device controller which bridges between
...
\begin{figure}[h]
  \centering
  \includegraphics[width=6.5in]{images/frs/bladeRF_architecture_block_diagram.pdf}
