...
\def \emailrghilduta    {\href{mailto:robert.ghilduta@nuand.com?cc=bladeRF@nuand.com}{robert.ghilduta@nuand.com}}
\def \emailbpadalino    {\href{mailto:brian.padalino@nuand.com?cc=bladeRF@nuand.com}{brian.padalino@nuand.com}}
\def \emailjszymaniak   {\href{mailto:jon.szymaniak@nuand.com?cc=bladeRF@nuand.com}{jon.szymaniak@nuand.com}}
...
\def \authors{
  \begin{table}[h]
    ...
    \begin{tabular}{ccc}
      ...
      \emailrghilduta & \emailbpadalino & \emailjszymaniak \\
      \afilnuand      & \afilnuand      & \afilnuand \\
    \end{tabular}
  \end{table}
  ~\\
}

% Place contributor email and affiliation definitions here

% Define contributors table here
%\def \contributors{
%  \begin{table}[h]
%    \centering
%    \begin{tabular}{c}
